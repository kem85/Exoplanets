...
const Exoplanet = () => {
  ...
  const exoplanetTexture1 = useLoader(
    TextureLoader,
...
const Exoplanet2 = () => {
  ...
  const exoplanetTexture2 = useLoader(
    TextureLoader,
...
const Method1 = () => {
  return (
    <>
      ...
      >
        <Canvas
          style={{ background: "black", height: "100%", width: "60%" }}
